...
type ApplicationConfiguration struct {
	...
	IntegrationTypeId int64 `gorm:"primaryKey:pk_cfg,priority:2;index:uk_cfg_rev,priority:2;uniqueIndex:uk_cfg_pk,priority:2"`
	TerminalModelId   int64 `gorm:"primaryKey:pk_cfg,priority:3;index:uk_cfg_rev,priority:1;uniqueIndex:uk_cfg_pk,priority:3"`
