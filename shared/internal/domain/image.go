...
type Image struct {
	...
	ApplicationDetails []ApplicationDetail `gorm:"many2many:application_detail_screenshots;joinForeignKey:ImageID;joinReferences:ApplicationDetailID;constraint:OnUpdate:RESTRICT,OnDelete:RESTRICT"`
}
